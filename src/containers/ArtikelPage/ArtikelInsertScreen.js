...
import {storeArtikel,uploadImage} from './actions';
...
const ArtikelInsertScreen = ({history,uploadImage,storeArtikel}) =>{
    ...
    const onSubmit = (data) =>{
      const artikelData = {
         ...
         storeArtikel(artikelData).then((e)=>{
    ...
    return(
      <>
        ...
        <SetTitle>Tambah Artikel</SetTitle>
        <hr/>
        <Container fluid>
...
const mapDispatchToProps = (dispatch) =>
  bindActionCreators({
    storeArtikel:storeArtikel,
    uploadImage:uploadImage,
  },dispatch)
export default connect(null,mapDispatchToProps)(ArtikelInsertScreen);
